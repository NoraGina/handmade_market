...
class FilteredProductsController extends AppController
{
    ...
    public function init(){
        ...
        public function addressLink($user, $address){
            $output="";
            if($user && $address){
                $id = $user['id'];
                    ...
                    <div class='modal-dialog modal-dialog-centered'>    
                        <div class='modal-content mb-3' >
                            ...
                            <div class='modal-body'>
                                <form action='updateShippingAddress/".$id."' method='POST' id='updateAddressForm' style='width:98%'>
                                    <fieldset class='form-group border border-2 border-black-50 rounded-2  p-3'>
                                        ...
                                        <button type='submit' class='btn btn-primary btn-block  col-12' id='addShippingAddressBtn'>Editează
